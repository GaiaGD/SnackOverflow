export default function Loading() {
  return (
    <main className="animate-pulse bg-brand-purple">
      {/* Hero skeleton */}
      <section className="py-24 px-6">
        <div className="mx-auto max-w-3xl text-center space-y-8">
          ...
          <div className="h-14 bg-brand-teal/30 rounded-2xl w-40 mx-auto" />
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <div className="flex gap-6 overflow-hidden">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex-none w-80 rounded-2xl border border-brand-teal/20 bg-white/10 p-6 space-y-4">
